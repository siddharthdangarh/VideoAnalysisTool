"""
Django settings for VideoAnalysisTool project.
...
ALLOWED_HOSTS = [
    env.str("BASE_URL").replace("https://", "").replace("http://", ""),
    'localhost',
    '127.0.0.1',
]
...
ROOT_URLCONF = 'VideoAnalysisTool.urls'
...
WSGI_APPLICATION = 'VideoAnalysisTool.wsgi.application'
...
# Add your ngrok domain to CSRF_TRUSTED_ORIGINS
